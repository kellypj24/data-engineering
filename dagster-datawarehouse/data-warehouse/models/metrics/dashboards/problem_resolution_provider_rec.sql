...
{{ import(ref('dim_user_company'), 'dim_user') }},
...
incoming as (
    ...
    select
         ...
         , dim_user.company_user_id                                     as pharmacist_user_id
    ...
    from fact_medication_problems
             ...
             join dim_user on dim_user.company_user_id = fact_finalized_medlist.user_id
