...
- [x] E4. [Tiered-severity validation framework with an audit log](#e4-tiered-severity-validation-framework-with-an-audit-log)
- [x] E3. [UTC timestamp generic test](#e3-utc-timestamp-generic-test)
